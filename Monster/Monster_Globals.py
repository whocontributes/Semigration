...
GM_LIST = ['(Skilled Mage) Stewart', '(Master Alchemist) Dorren', '(Master Fighter) Argel',
		   '(Master Romantic Chef) Glewyas', '(Wise Musical Child Prodigy) Goblin Bard', '(Master Archer) Granat',
		   '(Apprentice Addicted Archer) Granites', '(Master Executioner) Krug', '(Master Cleric) Comgan',
		   '(Seasoned Cleric) Agnes', '(Master Musician) Briana', '(Amateur Student) Lassar',
		   '(Amateur Warlord) Andras', '(Apprentice Commander) Tethra', '(Apprentice Holy Knight) Collen',
		   '(Apprentice Mage) Galvin', '(Apprentice Sailor) Admiral Owen', '(Apprentice Sharp Shooter) Riocard',
		   '(Fledgling Blacksmith) Ferghus', '(Fledgling Battle Alchemist) Heledd', '(Master Battle Alchemist) Eabha',
		   ...
		   '(Amateur Conqueror) Black Knight', '(Apprentice Bard) Nele', '(Apprentice Troubadour) Sinead',
		   '(Master Shaman) Kousai', '(Master of the Beasts) Ruwai', '(Master of the Single Life) Bryce',
		   '(Apprentice Warrior in Crush) Padan', '(Amateur Warrior) Trefor', 'Angry Bear', '(Master Druid) Tarlach',
		   '(Amateur Druid) Berched', '(Master Vanguard) Lileas', '(Amateur Repairer) Jennifer',
		   '(Apprentice Home Economist) Taunes', '(Master Addicted Archer) Annick', '(Master Addicted Swordsman) Lucas',
		   '(Master Dog Fighter) Fleta', '(Master Shepherd Fighter) Deian', '(Master Warrior) Aodhan',
		   '(Apprentice Ranger) Caitin', '(Senior Ranger) Kusina']
